 ...
 * correctly applied.
 */
const dataModulePaths: [InjectionToken<string>, string][] = [[ACCESS_CONTROL_BASE_PATH, '/access-control'],[APPROVAL_BASE_PATH, '/approval-service'],[ARRANGEMENT_MANAGER_BASE_PATH, '/arrangement-manager'],[AUDIT_BASE_PATH, '/audit-service'],[DEVICE_BASE_PATH, '/device-management-service'],[LIMIT_BASE_PATH, '/limit'],[NOTIFICATIONS_BASE_PATH, '/notifications-service'],[USER_BASE_PATH, '/user-manager'],[EMPLOYEE_BASE_PATH, '/employee'],[MESSAGES_BASE_PATH, '/messages-service'],[PAYMENT_ORDER_BASE_PATH, '/payment-order-service'],[USER_PROFILE_BASE_PATH, '/user-profile-manager']];
